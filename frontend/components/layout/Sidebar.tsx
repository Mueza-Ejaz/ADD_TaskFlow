    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-white/10 bg-[#050505]/80 backdrop-blur-2xl transition-all duration-300 shadow-[4px_0_18px_rgba(0,0,0,0.6)]">
      <div className="flex h-full flex-col px-4 py-8">
        ...
        <div className="mb-10 flex items-center justify-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg border-2 border-[#00FFD1] bg-[#00FFD1]/10 shadow-[0_0_10px_rgba(0,255,209,0.2)]">
            <svg 
        ...
        <div className="mt-auto pt-6 border-t border-white/5">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-white/75 transition-all duration-200 hover:bg-red-500/10 hover:text-red-400 group"
          >
